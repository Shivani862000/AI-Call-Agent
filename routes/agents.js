...
function normalizeAgentPayload(payload = {}) {
  ...
  return {
    ...
    voice_pipeline: String(payload.voice_pipeline || 'orchestrated').trim().toLowerCase() || 'orchestrated',
    ...
    tts_provider: String(payload.tts_provider || 'elevenlabs').trim().toLowerCase() || 'elevenlabs',
