...
const SETTING_DEFINITIONS = Object.freeze({
  ...
  'notificationTemplates.accountSuspended.subject': setting('string', 'Your user account has been suspended', { minLength: 1, maxLength: 200 }),
  'notificationTemplates.accountSuspended.body': setting('string', 'Your user account is currently suspended. Contact your administrator for assistance.', { minLength: 1, maxLength: 4000 }),
  'notificationTemplates.accountRestored.subject': setting('string', 'Your user account has been restored', { minLength: 1, maxLength: 200 }),
  'notificationTemplates.accountRestored.body': setting('string', 'Your user account has been restored.', { minLength: 1, maxLength: 4000 }),
  'notificationTemplates.accountArchived.subject': setting('string', 'Your user account has been archived', { minLength: 1, maxLength: 200 }),
  'notificationTemplates.accountArchived.body': setting('string', 'Your user account has been archived and retained.', { minLength: 1, maxLength: 4000 }),
