...
test('browser AI call opening line matches required script', () => {
  assert.equal(
    OPENING_LINE,
    'Namaste, main KC Prashant Path Lab se AI assistant bol rahi hoon. Main aapse aapke recent lab visit ka feedback lena chahti hoon. Kya main 1 minute le sakti hoon?'
  );
});
